...
def load_data(file_name, sequence_length=10, split=0.8):
    ...
    df_load = df.drop(['dayOfWeek', 'dayOfYear', 'dayOfMonth', 'weekOfYear', 'hourOfDay', 'monthOfYear'], axis=1)
...
def build_model(external_dim=10):
    ...
    lstm2 = LSTM(150, return_sequences=False)(lstm1)
    ...
    h1 = Dense(output_dim=150)(embedding)
